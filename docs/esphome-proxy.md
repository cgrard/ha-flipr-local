...
C'était un bug Home Assistant, **corrigé en amont** (correctif vérifié sur HA Core 2026.7.2) : [home-assistant/core#175664](https://github.com/home-assistant/core/issues/175664).
